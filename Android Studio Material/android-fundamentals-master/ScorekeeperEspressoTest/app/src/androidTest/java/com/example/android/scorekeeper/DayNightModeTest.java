...
public class DayNightModeTest {
    ...
    *      ViewInteraction actionMenuItemView = onView(
                allOf(withId(R.id.night_mode), withText("Night Mode"), withContentDescription("Night Mode"), isDisplayed()));
        actionMenuItemView.perform(click());

        ViewInteraction textView = onView(
                allOf(withId(R.id.night_mode), withText("Day Mode"), withContentDescription("Day Mode"), isDisplayed()));
