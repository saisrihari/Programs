...
/**
 * This activity handles radio buttons for choosing a delivery method for an order.
 */
public class OrderActivity extends AppCompatActivity {
    ...
    /**
     * Checks which radio button was clicked and displays a toast message to show the choice.
